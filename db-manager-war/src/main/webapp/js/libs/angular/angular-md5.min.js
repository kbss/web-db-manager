!function (window, angular) {
    angular.module("angular-md5", ["gdi2290.md5"]), angular.module("ngMd5", ["gdi2290.md5"]), angular.module("gdi2290.md5", ["gdi2290.gravatar-filter", "gdi2290.md5-service", "gdi2290.md5-filter"]), angular.module("gdi2290.gravatar-filter", []).filter("gravatar", ["md5", function (md5) {
        var cache = {};
        return function (text, defaultText) {
            return cache[text] || (defaultText = defaultText ? md5.createHash(defaultText.toString().toLowerCase()) : "", cache[text] = text ? md5.createHash(text.toString().toLowerCase()) : defaultText), cache[text]
        }
